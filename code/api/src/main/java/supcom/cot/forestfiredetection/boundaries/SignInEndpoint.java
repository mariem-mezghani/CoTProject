...
import supcom.cot.forestfiredetection.util.OAuth2PKCE;
import supcom.cot.forestfiredetection.controllers.UserManager;
import supcom.cot.forestfiredetection.util.Identity;
...
public class SignInEndpoint {
    ...
    public Response signIn(String json){
        ...
        try {
            ...
            // Obtenez le niveau d'autorisation de l'utilisateur
            Long permissionLevel = identity.getPermissionLevel();
            return Response.ok()
